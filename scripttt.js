    ...
    fried_rice: {
        ...
        sliders: {
            ...
            calzone :{
                ...
                name: "Calzone",
                ingredients: ["Pizza dough", "Mozzarella cheese", "Ricotta cheese", "Marinara sauce", "Pepperoni or desired fillings", "Olive oil"],
                steps: [
                    "Preheat the oven to 220°C (425°F).",
                    "Roll out the pizza dough into a circular shape.",
                    "Spread a thin layer of marinara sauce on one half of the dough, leaving edges clean.",
                    "Add mozzarella cheese, ricotta cheese, and your choice of fillings (like pepperoni, vegetables, or sausage).",
                    "Fold the dough over to form a semi-circle and seal the edges by pressing them together tightly.",
                    "Brush the top with olive oil and make a few small slits for ventilation.",
                    "Bake in the preheated oven for 15-20 minutes or until golden brown.",
                    "Let it cool slightly, then serve warm with extra marinara sauce for dipping."
                ],
                image: "https://www.allrecipes.com/thmb/Bwkz2gVOQUJcPYSzOJgD94XDi5Q=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/18874-Real-Italian-Calzones-ddmfs-127-4x3-1-a30a0e72801f42bcb0643ed4b57e8a3c.jpg"
            
               },
            green_tea:{
                name: "Green Tea",
                ingredients: ["Green tea leaves or tea bag", "Water", "Honey (optional)", "Lemon slice (optional)"],
                steps: [
                    "Boil water in a kettle until it reaches around 80-85°C (not boiling).",
                    "Place green tea leaves or a tea bag in a cup.",
                    "Pour the hot water over the tea and let it steep for 2-3 minutes.",
                    "Remove the tea bag or strain the leaves.",
                    "Add honey or a lemon slice for extra flavor, if desired.",
                    "Serve warm in a cup."
                ],image: "https://d2jx2rerrg6sh3.cloudfront.net/image-handler/picture/2021/9/shutterstock_251566309.jpg"
            },
            cola_float: {
                name: "Cola Float",
                ingredients: [
